{-# LANGUAGE KindSignatures, GADTs, TypeOperators, RankNTypes, GeneralizedNewtypeDeriving, StandaloneDeriving, MultiParamTypeClasses, FlexibleInstances, ScopedTypeVariables #-}
